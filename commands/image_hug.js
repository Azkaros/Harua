...
module.exports.run = async (client, message, args, level) => {
    ...
    if (args.length === 0) return message.reply(':x: h!hug <Personne mentionée>')
    ...
    superagent.get('https://nekos.life/api/v2/img/hug')
      ...
      .setColor(`#6389EF`)
      .setAuthor(`${message.author.username} vient de faire un calin à ${message.mentions.members.first().user.username} !`)
