...
module.exports.run = async (client, message, args, level) => {
    ...
    if (args.length === 0) return message.reply(':x: h!tickle <Personne mentionée>')
    ...
    superagent.get('https://nekos.life/api/v2/img/tickle')
      ...
      .setColor(`#6389EF`)
      .setAuthor(`${message.author.username} chatouille ${message.mentions.members.first().user.username} !`)
