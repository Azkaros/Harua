...
module.exports.run = async (client, message, args, level) => {
    ...
    if (args.length === 0) return message.reply(':x: h!feed <Personne mentionée>')
    ...
    superagent.get('https://nekos.life/api/v2/img/feed')
      ...
      .setColor(`#6389EF`)
      .setAuthor(`${message.author.username} nourrit ${message.mentions.members.first().user.username}`)
