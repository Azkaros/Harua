...
module.exports.run = async (client, message, args, level) => {
    ...
    if (args.length === 0) return message.reply(':x: h!cuddle <Personne mentionée>')
    ...
    superagent.get('https://nekos.life/api/v2/img/cuddle')
      ...
      .setColor(`#6389EF`)
      .setAuthor(`${message.author.username} réconforte ${message.mentions.members.first().user.username} !`)
